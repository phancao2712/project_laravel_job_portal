                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-8 col-lg-12">
                        <div class="block-banner">
                            <h1 class="heading-banner wow animate__animated animate__fadeInUp">{{ GoogleTranslate::trans($hero?->title, app()->getLocale()) }}</h1>
                            <div class="banner-description mt-20 wow animate__animated animate__fadeInUp"
                                data-wow-delay=".1s">
                                {{ GoogleTranslate::trans($hero?->sub_title, app()->getLocale()) }}
                            </div>
