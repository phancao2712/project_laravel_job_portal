      ...
      <div class="row align-items-center justify-content-between">
        <div class="col-lg-6 col-sm-12">
          <div class="content-job-inner"><span class="color-text-mutted text-32">{{ $learnMore?->title }}</span>
            ...
            <div class="mt-40 pr-50 text-md-lh28 wow animate__animated animate__fadeInUp">{{ $learnMore?->subtitle }}</div>
            <div class="mt-40">
              <div class="wow animate__animated animate__fadeInUp"><a class="btn btn-default"
                  href="{{ route('jobs.index') }}">Search Jobs</a><a class="btn btn-link" href="{{ $learnMore?->url }}">Learn More</a>
              </div>
            </div>
          </div>
        </div>
