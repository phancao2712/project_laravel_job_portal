                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-4 form-group select-style">
                                            ...
                                            <select name="country" id=""
                                                ...
                                                @foreach ($countries as $country)
                                                    <option @selected($country->id === $job?->country) value="{{ $country->id }}">
                                                        {{ $country->name }}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-sm-4 form-group select-style">
                                            ...
                                            <select name="province" id=""
                                                ...
                                                <option selected value="{{ $job?->province }}">
                                                    {{ $job->provinces?->name }}</option>
                                            </select>
                                        ...
                                        <div class="col-sm-4 form-group select-style">
                                            ...
                                            <select name="district" id=""
                                                ...
                                                <option selected value="{{ $job?->district }}">
                                                    {{ $job->districts?->name }}</option>
                                            </select>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-2 d-flex form-group">
                                            <input type="radio" name="salary_mode"
                                                ...
                                                onclick="changeSalaryMode('salary_range')" @checked($job?->salary_mode === 'range')
                                                style="height: 20px !important; width: 20px; margin-right: 10px;">
                                            <label>Salary Range</label>
                                            <x-input-error :messages="$errors->get('salary_mode')" class="mt-2" />
                                        </div>
                                        <div class="col-3 d-flex form-group">
                                            <input type="radio" name="salary_mode"
                                                class="from-control {{ hasError($errors, 'salary_mode') }}" value="custom"
                                                onclick="changeSalaryMode('salary_custom')" @checked($job?->salary_mode === 'custom')
                                                style="height: 20px !important; width: 20px; margin-right: 10px;">
                                        ...
                                        <div class="col-sm-12 form-group select-style">
                                            ...
                                            <select name="salary_type" id=""
                                                ...
                                                @foreach ($salary_types as $salary_type)
                                                    <option @selected($salary_type->id === $job->salary_type_id) value="{{ $salary_type->id }}">
                                                        {{ $salary_type->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="row">
                                    <div class="col-sm-6 form-group select-style">
                                        ...
                                        <select name="job_experience_id" id=""
                                            ...
                                            @foreach ($experiences as $exp)
                                                <option @selected($exp->id === $job->job_experience_id) value="{{ $exp->id }}">
                                                    {{ $exp->name }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-sm-6 form-group select-style">
                                        ...
                                        <select name="job_type_id" id=""
                                            ...
                                            @foreach ($job_types as $job_type)
                                                <option @selected($job_type->id === $job?->job_type_id) value="{{ $job_type->id }}">
                                    ...
                                    <div class="col-sm-12 form-group select-style">
                                        ...
                                        <select name="tags[]" id="" multiple
                                            ...
                                            @foreach ($tags as $tag)
                                                <option @selected(in_array($tag->id, $selected_tag)) value="{{ $tag->id }}">
                                                    {{ $tag->name }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-2 form-group d-flex">
                                            <input type="checkbox" name="featured"
                                                class="from-control {{ hasError($errors, 'featured') }}" value="1"
                                                style="height: 20px !important; width: 20px; margin-right: 10px;
                                                "
                                        ...
                                        <div class="col-2 form-group d-flex">
                                            <input type="checkbox" name="highlight"
                                                class="from-control {{ hasError($errors, 'highlight') }}" value="1"
                                                style="height: 20px !important; width: 20px; margin-right: 10px;"
