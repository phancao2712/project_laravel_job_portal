...
@section('contents')
    ...
    <section class="section-box-2">
        <div class="container">
          <div class="banner-hero banner-image-single"><img style="height: 375px; object-fit:cover;" src="{{ asset($company->banner) }}" alt="joblist"></div>
          <div class="box-company-profile">
            <div class="row mt-10">
              <div class="col-lg-8 col-md-12">
                <img style="width:100px; height:100px; object-fix:cover;" src="{{ asset($company->logo) }}" alt="">
                <h5 class="f-18">{{ $company->name }}<span class="card-location font-regular ml-20">{{ $company->companyCountry->name }}, {{ $company->companyProvince->name }}</span></h5>
              ...
              <div class="col-lg-4 col-md-12 text-lg-end"><a class="btn btn-apply btn-apply-big"
                  href="javascript:;" onclick="document.getElementById('open-position').scrollIntoView()">Open Postion</a></div>
            </div>
          </div>
                ...
                <div class="sidebar-heading">
                  <div class="avatar-sidebar">
                    <div class="sidebar-info pl-0"><span class="sidebar-company">{{ $company->name }}</span><span
                        class="card-location">{{ $company->companyCountry->name }},{{ $company->companyProvince->name }}</span></div>
                  </div>
                </div>
                ...
                <div class="sidebar-list-job">
                  <ul>
                    <li>
                      ...
                      <div class="sidebar-text-info"><span class="text-description">Industry Type</span><strong
                    ...
                    <li>
                      ...
                      <div class="sidebar-text-info"><span class="text-description">Etablish Date</span><strong
