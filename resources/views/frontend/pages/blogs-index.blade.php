                                                    ...
                                                    <div class="col-lg-6 col-6">
                                                        <div class="d-flex">
                                                            <div class="info-right-img"><span
                                                                    class="font-sm font-bold color-brand-1 op-70">{{ $blog->author->name }}</span><br>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6 text-end col-6 pt-15"><span
                                                            class="color-text-paragraph-2 font-xs">{{ formatDate($blog->created_at) }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        {{-- <div class="sidebar-shadow sidebar-news-small">
                            ...
                            <div class="post-list-small">
                                ...
                                <div class="post-list-small-item d-flex align-items-center">
                                    <figure class="thumb mr-15"><img src="{{ asset($blog->image) }}"
                                            alt="joblist">
                                    </figure>
                                    <div class="content">
                                        <h5>{{ $blog->title }}</h5>
                                        <div class="post-meta text-muted d-flex align-items-center mb-15">
                                            <div class="author d-flex align-items-center mr-20"><span>{{ $blog->author->name }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
