    ...
    <div class="container">
        <div class="main-header">
            ...
            <div class="header-right">
                ...
                <div class="block-signin" style="display: flex; align-items:center;">
                    <div class="dropdown">
                        <a class=" btn-secondary dropdown-toggle" href="#" role="button" id="dropdownMenuLink"
                            data-bs-toggle="dropdown" aria-expanded="false">
                            {{ GoogleTranslate::trans('Ngôn ngữ', app()->getLocale()) }}
                        </a>
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                            <li><a class="dropdown-item" href="{{ route('lang.change', 'vi') }}">Việt Nam</a></li>
                    ...
                    @guest
                        <a class="btn btn-default btn-shadow ml-30 hover-up" href="{{ route('login') }}">Sign in</a>
                    @endguest
