        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('admin.blogs.create') }}" class="btn btn-primary"><i class="fa-solid fa-circle-plus"></i> Create New</a>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-md">
                            <tbody >
                                ...
                                <tr>
                                    <td>
                                        <img src="{{ $blog->image }}" style="object-fit: cover" width="70px" height="50px" alt="">
                                    </td>
                                    <td>{{ $blog->title }}</td>
                                    ...
                                    <td>
                                        <label class="custom-switch mt-2">
                                            <input @checked($blog->status == 1) type="checkbox" name="custom-switch-checkbox" class="custom-switch-input btn-change" data-id="{{ $blog->id }}">
                                            <span class="custom-switch-indicator"></span>
                                        </label>
                                    </td>
                                    <td >
                                        <a href="{{ route('admin.blogs.edit', $blog->id) }}" class="btn btn-sm btn-primary"><i class="fa-solid fa-pen-to-square"></i></a>
                                        <a href="{{ route('admin.blogs.destroy', $blog->id) }}" class="btn btn-sm btn-danger delete-btn"><i class="fa-solid fa-trash"></i></a>
                                    </td>
                                </tr>
                                @empty
                                <tr>
